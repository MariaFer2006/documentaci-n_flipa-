# 1. Visión de negocio: problema, propuesta de valor y modelo
...
> **Nota (Check-in de Producto, 15 jul 2026):** este documento fusiona lo que antes eran tres archivos separados —"Problema de negocio", "Propuesta de valor" y "Modelo de negocio"— dada su brevedad y su relación directa (problema → cómo lo resuelve el producto → cómo se sostiene el negocio).

## Fuentes consultadas

- Investigación B2B (`Modelo Cobranza/Investigacion B2B.docx`)
- Modelo Comercial B2B — *Modelo Comercial B2B.pptx*
- Notas de la reunión "Producto: Check-in" (15 jul 2026) y su transcripción asociada — ajuste de 72h/3 cuotas a 24h/1 cuota; fusión de secciones.
