...
Esta carpeta describe el negocio detrás del producto: propuesta de valor, actores, procesos, reglas y métricas. Sirve de puente entre la visión de producto y la operación funcional del sistema.

## Responsable

Equipo de negocio, producto y operaciones
