...
>
> **Nota (Check-in de Producto, 15 jul 2026):** se confirmó "Fliipa" como la única denominación del equipo interno responsable del producto, en reemplazo de "Administrador del producto". Sumz es la empresa matriz; Fliipa es el equipo/producto que opera dentro de ella — no son dos actores distintos en este mapa, por lo que no se lista "Sumz" como una fila separada.
...
- Notas de la reunión "Producto: Check-in" (15 jul 2026) y su transcripción asociada — reemplazo de "Administrador del producto" por "Fliipa".
